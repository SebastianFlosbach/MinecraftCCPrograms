...
Options = {
	{"Length", function() isSettingOption = true end, function() return Settings.GetValue("TunnelLength") end, function(value) Settings.SetValue("TunnelLength", value) end},
	{"Height", function() isSettingOption = true end, function() return Settings.GetValue("TunnelHeight") end, function(value) Settings.SetValue("TunnelHeight", value) end}
}
